...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.custom_cmd1_ret'
        db.add_column('jobmng_job', 'custom_cmd1_ret', self.gf('django.db.models.fields.CharField')(default='', max_length=10240, blank=True), keep_default=False)

        # Adding field 'Job.custom_cmd2_ret'
        db.add_column('jobmng_job', 'custom_cmd2_ret', self.gf('django.db.models.fields.CharField')(default='', max_length=10240, blank=True), keep_default=False)

        # Adding field 'Job.custom_cmd3_ret'
        db.add_column('jobmng_job', 'custom_cmd3_ret', self.gf('django.db.models.fields.CharField')(default='', max_length=10240, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.custom_cmd1_ret'
        db.delete_column('jobmng_job', 'custom_cmd1_ret')

        # Deleting field 'Job.custom_cmd2_ret'
        db.delete_column('jobmng_job', 'custom_cmd2_ret')

        # Deleting field 'Job.custom_cmd3_ret'
        db.delete_column('jobmng_job', 'custom_cmd3_ret')
