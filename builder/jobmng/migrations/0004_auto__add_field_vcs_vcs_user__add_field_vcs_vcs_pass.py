...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vcs.vcs_user'
        db.add_column('jobmng_vcs', 'vcs_user', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Vcs.vcs_pass'
        db.add_column('jobmng_vcs', 'vcs_pass', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vcs.vcs_user'
        db.delete_column('jobmng_vcs', 'vcs_user')

        # Deleting field 'Vcs.vcs_pass'
        db.delete_column('jobmng_vcs', 'vcs_pass')
    ...
    models = {
        ...
        'jobmng.job': {
            ...
            'topo_url_create_build': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'blank': 'True'}),
